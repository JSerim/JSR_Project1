            ...
            <form name="join" action="edit.php" method="post" onsubmit="return edit_form_check()">
                ...
                <fieldset class="join_form_wrap">
                    ...
                    <p>
                        ...
                        <input type="text" class="ps_code" name="ps_code" id="ps_code" placeholder="우편번호" value="<?php echo $array["ps_code"]; ?>">
                                ...
                                <ul>
                                    ...
                                    <li class="refund_li2">
                                        ...
                                        <select name="bank_sel" id="bank_sel" class="bank_sel">
                                            <option value=""<?php if($array["bank"]=="") echo " selected"; ?>>- 은행선택 -</option>
                    ...
                    <p class="btn"><button type="button" class="delete_info" name="delete_info" id="delete_info" onclick="mem_del()">회원탈퇴</button></p>
            </form>
        </section>
    </main>
