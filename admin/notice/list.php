...
<head>
    ...
    <style type="text/css">
        ...
        .write_area{width:1000px;margin:auto;padding-top:30px}
        .write_area p{font-size:20px;float:left; margin-bottom:20px}
        .write_area span{font-size:20px;float:right; margin-bottom:20px}
        .no{width:50px;}
        .n_title{width:500px}
        .writer{width:100px}
        .w_date{width:100px}
        .modify{width:100px}
        .notice_content_title{text-align:left;}
    </style>
    <script>
